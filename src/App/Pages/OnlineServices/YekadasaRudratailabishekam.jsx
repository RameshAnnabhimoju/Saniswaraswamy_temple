...
const YekadasaRudratailabishekam = () => {
  const navigate = useNavigate();
  const initiatePayment = ()=>{
    localStorage.setItem("mandapalliSaneswara_poojaDetails",JSON.stringify(pooja_values))
  ...
  return (
    <div className='Yekadasa_rudratailabishekam'>
      ...
      <form className='donations_form' action="">
        ...
        <div>
          ...
          <select name="pooja" value={pooja_values.pooja} onChange={changeHandler} id="">
            <option value="1 సారి పూజకు">
            1 సారి పూజకు
            </option>
            <option value="1సం.లో వచ్చే 52 శనివారములకు">
            1సం.లో వచ్చే 52 శనివారములకు
            </option>
            <option value="శాశ్వత అభిషేకము">
            శాశ్వత అభిషేకము
            </option>
            <option value="శాశ్వత శనిత్రయోదశులు">
        ...
        <div>
          ...
          <input name='poojaDate' value={pooja_values.poojaDate} onChange={changeHandler} type="date" />
        </div>
      ...
      <div>
        <button className='btn btn-primary' onClick={initiatePayment}>Continue</button>
      </div>
    </div>
  )
}

export default YekadasaRudratailabishekam